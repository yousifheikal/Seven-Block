@section('title')
    Seven-Block | Section-Finishing-Regular
@stop
<main>
    <div class="container">
        <div class="wrap-breadcrumb">
            <ul>
                <h2>@lang('sections.Hello') @lang('sections.in Finishing Section')</h2>
            </ul>
        </div>
                    ...
                    <div class="advance-info">
                        ...
                        <div class="tab-contents">
                            <div class="tab-content-item active" id="description">
                                <p>@lang('sections.Hello this page display important rule in Finishing Section')</p>
                            </div>
                ...
                <div class="widget widget-our-services ">
                    <div class="widget-content">
                        <ul class="our-services">
                            ...
                            <li class="service">
                                <img src="{{asset('assets/images/projects/finishing.jpg')}}" style="width: 100%;height: 500px; border-radius: 10px" alt="not-found">
