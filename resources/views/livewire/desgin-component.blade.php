<!--main area-->
@section('title')
    Seven-Block | Section-Design-Customer
@stop
...
<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                <h2>@lang('sections.Hello'): {{ucfirst(\Illuminate\Support\Facades\Auth::user()->name)}} @lang('sections.in Design Section')</h2>
            </ul>
        </div>
                    ...
                    <div class="advance-info">
                        ...
                        <div class="tab-contents">
                            <div class="tab-content-item active" id="description">
                                <p>@lang('sections.Hello'): {{$project->user->name}} @lang('sections.This is last version in design')</p>
                            </div>
                ...
                <div class="widget widget-our-services ">
                    <div class="widget-content">
                        <ul class="our-services">
                            ...
                            <li class="service">
                                <img src="{{asset('assets/images/projects/design.jpg')}}" style="width: 100%;height: 500px; border-radius: 10px" alt="not-found">
