<!--main area-->
@section('title')
    Seven-Block | Section-Foundation-Customer
@stop
...
<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                <h2>@lang('sections.Hello'): {{ucfirst(\Illuminate\Support\Facades\Auth::user()->name)}} @lang('sections.in Foundation Section')</h2>
            </ul>
        </div>
