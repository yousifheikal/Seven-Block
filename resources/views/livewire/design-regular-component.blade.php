@section('title')
    Seven-Block | Section-Design-Regular
@stop
...
<main>
    <div class="container">
        <div class="wrap-breadcrumb">
            <ul>
                <h2>@lang('sections.Hello') @lang('sections.in Design Section')</h2>
            </ul>
        </div>
                    ...
                    <div class="advance-info">
                        ...
                        <div class="tab-contents">
                            <div class="tab-content-item active" id="description">
                                <p>@lang('sections.Hello this page display important rule in Design Section')</p>
                            </div>
